 ...
 * departments module
 */
define(['ojs/ojcore', 'knockout','ojs/ojtable', 'ojs/ojarraytabledatasource','ojs/ojpagingcontrol', 'ojs/ojpagingtabledatasource'
], function (oj, ko) {
    /**
     * The view model for the main content view template
     */
    function departmentsContentViewModel() {
        var self = this;
    ...
    return departmentsContentViewModel;
});
